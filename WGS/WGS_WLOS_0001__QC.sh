#!/bin/bash
#SBATCH --job-name=WLOS_0001__Summarized_BWA_WGS         # Job name (WLOS_0001__Summarized_BWA_WGS)
...
#SBATCH --output=WLOS_0001__Summarized_BWA_WGS.%j.out    # Standard output log
#SBATCH --error=WLOS_0001__Summarized_BWA_WGS.%j.err     # Standard error log


Cancer_Type='OSA'
sample_name="WLOS_0001_"
source_folder='/scratch/jlw87619/PanK9cancer/WGS_Osteosarcoma_PRJNA525883/results/WLOS_0001_' #
sam_file_output='/scratch/kh31516/Pan_cancer/OSA_WGS/QC/WLOS_0001_'
script='/home/kh31516/kh31516_Lab_Share_script'
summary_output='/scratch/kh31516/Original_Melanoma/WGS/WGS/store'
DepthOfCoverage='/scratch/jlw87619/PanK9cancer/WGS_Osteosarcoma_PRJNA525883/results/WLOS_0001_'
Mutect='/scratch/jlw87619/PanK9cancer/WGS_Osteosarcoma_PRJNA525883/results/WLOS_0001_'
Sequence_length=151
Normal_Sample='SRR8691711'
Tumor_Sample='SRR8691710'
