...
plot_result <- png("G:\\MAC_Research_Data\\Pan_cancer\\Pan_cancer_mapping_result\\Supplement_Figure1\\gt-30.png",
                   width=2800,height=1800,res=400)
...
total_file %>% 
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        axis.title.x = element_blank(),
        #axis.ticks.x = element_blank(),
        axis.title.y = element_text(colour="black",size=23,margin = margin(1,5,0,0)),
        text = element_text(colour="black",size=14),
        #axis.text.x = element_text(colour=c("black"),size=14,vjust=1,hjust = 0.9, angle = 45),
        axis.text.x = element_blank(),
...
callable %>% 
  ...
  theme(axis.line = element_line(colour = "black"),
        ...
        axis.title.x = element_blank(),
        #axis.ticks.x = element_blank(),
        axis.title.y = element_text(colour="black",size=24,margin = margin(1,40,0.5,0)),
